...
class MNIST(object):
    ...
    # check with Zebo to main to be called in main
	def train(self, x_train, y_train, x_valid, y_valid, max_epoch, validation=True):
		print('###Train###')
		...
		for epoch in range(1, max_epoch+1):
			...
			if validation and x_valid is not None and y_valid is not None:
				...
				# checking with zebo  x_test --> x_valid   y_test y_valid
				preds = []
