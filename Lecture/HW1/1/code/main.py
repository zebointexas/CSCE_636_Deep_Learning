...
def visualize_features(X, y):
    ...
    plt.scatter(X_2[:,0],X_2[:,1],s=10,c='red',marker='o',alpha=0.5,label='-1')
    plt.scatter(X_1[:,0],X_1[:,1],s=10,c='blue',marker='x',alpha=0.5,label='1')
   
#    plt.scatter(X[:,1],y,s=100,c='red',marker='o',alpha=0.5,label='Intensity')
...
def visualize_result(X, y, W):
    ...
    plt.scatter(X[:,0],X[:,1],s=10,c='blue',marker='o',alpha=0.5,label='Truth')
 
    
    
    plt.title('Predition Error')
    plt.xlabel('Symmetry')
    plt.ylabel('Intensity')
...
#    # Visualize training data.
   ...
   ##### Check GD, SGD, BGD
    ...
    w_zebo = np.array([2,2,2])
    logisticR_classifier.assign_weights(w_zebo)
    print('------------Logistic Regression Sigmoid Case | GD------------')
    logisticR_classifier.fit_GD(train_X, train_y)
    print(logisticR_classifier.get_params())
    print(logisticR_classifier.score(train_X, train_y))
    
   # print(logisticR_classifier.predict_proba(train_X))

    w_zebo = np.array([2,2,2])
    logisticR_classifier.assign_weights(w_zebo)
    print('------------Logistic Regression Sigmoid Case | SGD------------')
    ...
    w_zebo = np.array([2,2,2])
    logisticR_classifier.assign_weights(w_zebo)
    print('------------Logistic Regression Sigmoid Case | BGD  data_shape ------------')
    print('data_shape')
    print(data_shape)
    ...
    w_zebo = np.array([2,2,2])
    logisticR_classifier.assign_weights(w_zebo)
    print('------------Logistic Regression Sigmoid Case | BGD   1 ------------')
    ...
    w_zebo = np.array([2,2,2])
    logisticR_classifier.assign_weights(w_zebo)
    print('------------Logistic Regression Sigmoid Case | BGD   10 ------------')
    logisticR_classifier.fit_BGD(train_X, train_y, 10)
    print(logisticR_classifier.get_params())
    
    max_W = logisticR_classifier.get_params()
    ...
    print('------------ Visualize the your best model after training. ------------')
 
    visualize_result(train_X[:, 1:3], train_y, max_W)
